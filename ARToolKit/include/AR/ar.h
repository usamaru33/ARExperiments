...
* \param vertex position of the vertices of the marker. (in observed screen coordinates)
		 rem:the first vertex is stored again as the 5th entry in the array Efor convenience of drawing a line-strip easier.
* 
*/
typedef struct {
    int     area;
...
* \return the identity number of the pattern loaded or E if the pattern load failed.
*/
